...
namespace Gym.Migrations
{
    ...
    [Migration("20240524151834_ModfiedOnMessageAndUserBlock")]
    partial class ModfiedOnMessageAndUserBlock
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Models.UserBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gym.Models.Notification", b =>
                {
                    b.HasBaseType("Gym.Models.Message");
            ...
            modelBuilder.Entity("Gym.Models.UserBlock", b =>
                {
                    b.HasOne("Gym.Models.ApplicationUser", "Blocked")
                        .WithMany()
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("Gym.Models.ApplicationUser", "Blocker")
                        .WithMany()
